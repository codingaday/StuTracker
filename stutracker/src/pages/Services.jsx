          ...
          <div className="space-y-8">
            ...
            <div className="bg-[var(--primary-bg-end)] p-6 rounded-lg shadow-lg">
              ...
              <p className="text-lg text-[var(--text-secondary)] leading-relaxed">
                ...
                performance to identify areas for improvement, ensuring everyone
                stays on track.
              </p>
            </div>
            ...
            <div className="bg-[var(--primary-bg-end)] p-6 rounded-lg shadow-lg">
              ...
              <p className="text-lg text-[var(--text-secondary)] leading-relaxed">
                ...
                details like teacher information, and stay organized with their
                academic schedule.
              </p>
            </div>
            ...
            <div className="bg-[var(--primary-bg-end)] p-6 rounded-lg shadow-lg">
              ...
              <p className="text-lg text-[var(--text-secondary)] leading-relaxed">
                Students can set and track personal academic goals, helping them
                stay motivated and focused. This feature encourages
            ...
            <div className="bg-[var(--primary-bg-end)] p-6 rounded-lg shadow-lg">
              ...
              <p className="text-lg text-[var(--text-secondary)] leading-relaxed">
                ...
                students to maintain consistent study habits. It’s a fun way to
                build momentum and stay committed to learning.
              </p>
            </div>
            ...
            <div className="bg-[var(--primary-bg-end)] p-6 rounded-lg shadow-lg">
              ...
              <p className="text-lg text-[var(--text-secondary)] leading-relaxed">
                Students can participate in daily quiz challenges to test their
                knowledge and reinforce learning. This feature makes studying

        ...
        <section className="bg-gradient-to-r from-[var(--primary-bg-start)] to-[var(--primary-bg-end)] py-16 text-center">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <p className="text-lg md:text-xl text-[var(--text-secondary)] mb-6">
              Empowering students and teachers to achieve academic success
              through seamless progress tracking and course management.
            </p>
          </div>
        </section>
        ...
        <section className="py-12 bg-[var(--primary-bg-end)]">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <p className="text-lg text-[var(--text-secondary)] leading-relaxed">
              ...
              lives. Our mission is to provide a user-friendly platform that
              helps students stay on top of their academic goals and enables
              teachers to manage their courses effectively. We aim to foster a
              collaborative environment where learning is engaging, organized,
        ...
        <section className="py-12">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <p className="text-lg text-[var(--text-secondary)] leading-relaxed mb-4">
              ...
              their progress, set goals, and view enrolled courses, while
              teachers can create courses, add students, and track class
              performance.
            </p>
            <p className="text-lg text-[var(--text-secondary)] leading-relaxed">
              The project was developed using modern web technologies like
              React, Vite, and Tailwind CSS, ensuring a fast, responsive, and
              visually appealing experience. While currently using mock data
              with `localStorage`, StuTracker is designed to scale with a real
          ...
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-lg text-[var(--text-secondary)] leading-relaxed max-w-md">
                ...
                teachers stay organized and motivated in their academic
                journeys.
              </p>
            </div>
          </div>
